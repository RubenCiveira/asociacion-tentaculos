    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h2 className="text-2xl font-bold text-gray-800">{evento.titulo}</h2>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-5 space-y-3">
        ...
        {evento.descripcion && (
          <p className="text-sm text-gray-600 whitespace-pre-line pt-2 border-t border-gray-50">
            {evento.descripcion}
          </p>
        )}
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-5">
        ...
        {asistentes.length === 0 ? (
          <p className="text-sm text-gray-400 text-center py-4">Sin asistentes registrados</p>
        ) : (
      ...
      {evento.notas && (
        <div className="bg-white rounded-xl border border-gray-100 p-5">
          <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-2">Notas</h3>
          <p className="text-sm text-gray-600 whitespace-pre-line">{evento.notas}</p>
        </div>
      )}
